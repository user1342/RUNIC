...
public class SettingsFinder {
    ...
    public boolean getAdbEnabled() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        return getInt("adb_enabled", 0) != 0;
    }

    public boolean nonMarketAppsEnabled() throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
